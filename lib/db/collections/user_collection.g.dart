...
void _userCollectionSerialize(
  ...
  writer.writeDateTime(offsets[1], object.registeredAt);
...
UserCollection _userCollectionDeserialize(
  ...
  object.registeredAt = reader.readDateTimeOrNull(offsets[1]);
...
extension UserCollectionQueryProperty
  ...
  QueryBuilder<UserCollection, String?, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
